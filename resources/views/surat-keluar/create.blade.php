                    ...
                    <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="progja" id="progja" value="{{ old('progja') }}"
                                class="w-full text-white bg-zinc-800 rounded-md border-zinc-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('progja') border-red-500 @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tanggal_surat" id="tanggal_surat"
                                ...
                                class="js-datepicker w-full text-white bg-zinc-800 rounded-md border-zinc-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('tanggal_surat') border-red-500 @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tanggal_keluar" id="tanggal_keluar"
                                ...
                                class="js-datepicker w-full text-white bg-zinc-800 rounded-md border-zinc-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('tanggal_keluar') border-red-500 @enderror"
                                placeholder="dd-mm-yyyy" autocomplete="off">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tujuan" id="tujuan" value="{{ old('tujuan') }}"
                                class="w-full text-white bg-zinc-800 rounded-md border-zinc-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('tujuan') border-red-500 @enderror">
